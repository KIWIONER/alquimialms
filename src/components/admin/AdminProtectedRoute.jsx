...
const AdminProtectedRoute = ({ children }) => {
    ...
    const isAdmin = ['matiasidiartviera@gmail.com', 'director@agencialquimia.com'].includes(session.user.email);
            ...
            <div className="min-h-screen flex items-center justify-center bg-slate-950 p-6">
                <div className="w-full max-w-md bg-white rounded-[2.5rem] shadow-2xl p-10 text-center animate-in fade-in zoom-in">
                    ...
                    <button 
                        ...
                        className="mt-8 w-full bg-slate-900 text-white rounded-2xl py-4 font-black uppercase tracking-[0.2em] text-xs hover:bg-slate-800 transition-all"
                    >
                        Cerrar Sesión
                    </button>
                </div>
